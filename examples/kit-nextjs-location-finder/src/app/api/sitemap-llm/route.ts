  ...
  try {
    ...
    if (urls.length === 0) {
      ...
      urls = [
        ...
        { loc: `${baseUrl}/Products/Aero`, lastmod: today, priority: '0.8' },
        { loc: `${baseUrl}/Products/Terra`, lastmod: today, priority: '0.8' },
        { loc: `${baseUrl}/Products/Nexa`, lastmod: today, priority: '0.8' },
        { loc: `${baseUrl}/Test Drive`, lastmod: today, priority: '0.8' },
      ];
    }
